...
//components 
import MedDetails from '../components/Pharmacist/MedDetails'
    ...
    return (
        <div className="Medicines">
            <div className="medicine">
                ...
                <Link to="/viewAllMedicines"><button type="submit">Go to view all Med Details/Search/Filter</button></Link>
